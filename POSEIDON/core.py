...
def define_model(model_name, bulk_species, param_species,
                 ...
                 cloud_type = 'deck', high_res_method=None, opaque_Iceberg = False,
                 ...
                 surface = False, high_res_params = [], sharp_DN_transition = False,
    ...
    N_params_cum = assign_free_params(param_species, object_type, PT_profile,
                                      ...
                                      opaque_Iceberg, surface, high_res_params,
    ...
    model = {'model_name': model_name, 'object_type': object_type,
             ...
             'high_res_method': high_res_method, 'gravity_setting': gravity_setting, 
