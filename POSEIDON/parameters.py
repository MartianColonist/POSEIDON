...
def assign_free_params(
    ...
    # Models including atmospheres
        ...
        if (PT_profile == "isotherm") and (PT_dim > 1):
            raise Exception(
                "Cannot retrieve multiple PT profiles with an isothermal shape"
            )
                        ...
                        if TwoD_type == "E-M":
                            if (species_EM_gradient != []) and (
                                ...
                                if (species_vert_gradient != []) and (
                                    ...
                                    if X_profile == "gradient":
                                        X_params += [
                                            "log_" + species + "_Even_high",
                                            "log_" + species + "_Morn_high",
                                            "log_" + species + "_deep",
                                        ]
                                    elif X_profile == "two-gradients":
                                        X_params += [
                                            "log_" + species + "_Even_high",
                                            "log_" + species + "_Even_mid",
                                            "log_" + species + "_Morn_high",
                                            "log_" + species + "_Morn_mid",
                                            "log_P_" + species + "_mid",
                                            "log_" + species + "_deep",
                                        ]
                        ...
                        if TwoD_type == "D-N":
                            if (species_DN_gradient != []) and (
                                ...
                                if (species_vert_gradient != []) and (
                                    ...
                                    if X_profile == "gradient":
                                        X_params += [
                                            "log_" + species + "_Day_high",
                                            "log_" + species + "_Night_high",
                                            "log_" + species + "_deep",
                                        ]
                                    elif X_profile == "two-gradients":
                                        X_params += [
                                            "log_" + species + "_Day_high",
                                            "log_" + species + "_Day_mid",
                                            "log_" + species + "_Night_high",
                                            "log_" + species + "_Night_mid",
                                            "log_P_" + species + "_mid",
                                            "log_" + species + "_deep",
                                        ]
                                else:  # No altitude variation for this species
                        ...
                        if TwoD_type == "E-M":
                            if (species_EM_gradient != []) and (
                                ...
                                if (species_vert_gradient != []) and (
                                    ...
                                    if X_profile == "gradient":
                                        X_params += [
                                            "log_" + species + "_bar_term_high",
                                            "Delta_log_" + species + "_term_high",
                                            "log_" + species + "_deep",
                                        ]
                                    elif X_profile == "two-gradients":
                                        X_params += [
                                            "log_" + species + "_bar_term_high",
                                            "log_" + species + "_bar_term_mid",
                                            "Delta_log_" + species + "_term_high",
                                            "Delta_log_" + species + "_term_mid",
                                            "log_P_" + species + "_mid",
                                            "log_" + species + "_deep",
                                        ]
                                else:  # No altitude variation for this species
                                    X_params += [
                                        "log_" + species + "_bar_term",
                                        "Delta_log_" + species + "_term",
                                    ]
                        ...
                        if TwoD_type == "D-N":
                            if (species_DN_gradient != []) and (
                                ...
                                if (species_vert_gradient != []) and (
                                    ...
                                    if X_profile == "gradient":
                                        X_params += [
                                            "log_" + species + "_bar_DN_high",
                                            "Delta_log_" + species + "_DN_high",
                                            "log_" + species + "_deep",
                                        ]
                                    elif X_profile == "two-gradients":
                                        X_params += [
                                            "log_" + species + "_bar_DN_high",
                                            "log_" + species + "_bar_DN_mid",
                                            "Delta_log_" + species + "_DN_high",
                                            "Delta_log_" + species + "_DN_mid",
                                            "log_P_" + species + "_mid",
                                            "log_" + species + "_deep",
                                        ]
                                else:  # No altitude variation for this species
                                    X_params += [
                                        "log_" + species + "_bar_DN",
        ...
        # Patchy cloud model from MacDonald & Madhusudhan (2017)
            ...
            if cloud_dim not in [1, 2]:
                raise Exception(
                    "The MacDonald & Madhusudhan (2017) cloud model "
                ...
                # Convert input parameters into average terminator mixing ratios and differences (high and mid atmosphere)
                    ...
                    if (
                        ...
                        if (species_vert_gradient != []) and (
                            ...
                            if TwoD_param_scheme == "absolute":
                                log_X_bar_high = 0.5 * (
                                    log_X_in[count] + log_X_in[count + 1]
                                )
                                log_X_bar_mid = 0.5 * (
                                    log_X_in[count + 2] + log_X_in[count + 3]
                                )
                                ...
                                log_X_bar_mid = log_X_in[count + 1]
                                if TwoD_type == "D-N":
                                    Delta_log_X_high = -1.0 * (
                                        log_X_in[count + 2] * beta
                                    )
                                    Delta_log_X_mid = -1.0 * (
                                        log_X_in[count + 3] * beta
                                    )
                                elif TwoD_type == "E-M":
                                    Delta_log_X_high = -1.0 * (
                                        log_X_in[count + 2] * alpha
                                    )
                                    Delta_log_X_mid = -1.0 * (
                                        log_X_in[count + 3] * alpha
                                    )
                            ...
                            if TwoD_param_scheme == "absolute":
                                ...
                                if TwoD_type == "D-N":
                                    Delta_log_X_high = -1.0 * (
                                        log_X_in[count + 1] * beta
                                    )
                                    Delta_log_X_mid = Delta_log_X_high
                                elif TwoD_type == "E-M":
                                    Delta_log_X_high = -1.0 * (
                                        log_X_in[count + 1] * alpha
                                    )
                                    Delta_log_X_mid = Delta_log_X_high
...
def unpack_cloud_params(
    param_names, clouds_in, cloud_model, cloud_dim, N_params_cumulative, TwoD_type
):
    """
    ...
    if cloud_model == "MacMad17":
        ...
        if enable_deck == 1:
            P_cloud = np.power(
                10.0, clouds_in[np.where(cloud_param_names == "log_P_cloud")[0][0]]
            )
        else:
    ...
    # 3D patchy cloud model from MacDonald & Lewis (2022)
        ...
        if enable_deck == 1:
            ...
            if "log_kappa_cloud" in cloud_param_names:
                kappa_cloud_0 = np.power(
                    10.0,
                    clouds_in[np.where(cloud_param_names == "log_kappa_cloud")[0][0]],
                )
            else:
                kappa_cloud_0 = 1.0e250
            ...
            if cloud_dim == 1:
                ...
                if TwoD_type == "D-N":
                    f_cloud, phi_0 = (
                        1.0,
                        -90.0,
                    )  # Uniform axially, not-uniform along ray
...
def unpack_stellar_params(
    param_names, star, stellar_in, stellar_contam, N_params_cumulative
):
    """
    ...
    if "one_spot" in stellar_contam:
        ...
        if "free_log_g" in stellar_contam:
            log_g_het = np.array(
                stellar_in[np.where(stellar_param_names == "log_g_het")[0][0]]
            )
            log_g_phot = np.array(
                stellar_in[np.where(stellar_param_names == "log_g_phot")[0][0]]
            )
        else:
    ...
    # Extract parameters for two stellar heterogeneities
        ...
        if "free_log_g" in stellar_contam:
            log_g_spot = np.array(
                stellar_in[np.where(stellar_param_names == "log_g_spot")[0][0]]
            )
            log_g_fac = np.array(
                stellar_in[np.where(stellar_param_names == "log_g_fac")[0][0]]
            )
            log_g_phot = np.array(
                stellar_in[np.where(stellar_param_names == "log_g_phot")[0][0]]
            )
