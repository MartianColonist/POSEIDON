...
from .stellar import precompute_stellar_spectra, stellar_contamination_single_spot, stellar_contamination_general
...
def forward_model(param_vector, planet, star, model, opac, data, wl, P, P_ref_set,
                  ...
                  constant_gravity, chemistry_grid, high_res):
    '''
    ADD DOCSTRING
    '''
    ...
    offset_params, err_inflation_params, high_res_params = split_params(param_vector, N_params_cum)
...
def PyMultiNest_retrieval(planet, star, model, opac, data, prior_types, 
    ...
    def LogLikelihood(cube, ndim, nparams):
        ...
        _, _, _, _, \
        _, stellar_params, \
        _, _, high_res_params = split_params(cube, N_params_cum)
...
def retrieved_samples(planet, star, model, opac, data, retrieval_name, wl, P, 
                      ...
                      I_het_grid, y_p, F_s_obs, constant_gravity, 
                      chemistry_grid, N_output_samples, high_res):
    '''
    ADD DOCSTRING
    '''
