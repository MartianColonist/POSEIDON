...
masses = {'H2O':   18.010565, 'CO2':   43.989830, 'CH4':   16.031300, 
          ...
          'CH3CN': 41.026549, 'CH3OH': 32.026215, '   ': 49.992328,
          'GeH4':  77.952478, 'CS2':   75.944142, 'O2':    31.989830,
          'O3':    47.984745, 'Al':    26.981539, 'Ba':    137.32770,
          'Ba+':   137.32770, 'Ca':    40.078400, 'Ca+':   40.078400, 
          'Cr':    51.996160, 'Cs':    132.90545, 'Fe':    55.845200, 
          'Fe+':   55.845200, 'Li':    6.9675000, 'Mg':    24.305500,
          'Mg+':   24.305500, 'Mn':    54.938044, 'Ni':    58.693440, 
          'O':     15.999400, 'Rb':    85.467830, 'Sc':    44.955908, 
          'Ti':    47.867100, 'Ti+':   47.867100, 'V':     50.941510, 
          'V+':    50.941510, 'H2':    2.0156500, 'He':    4.0026030, 
          'H':     1.0078250, 'N2':    28.006148, 'H-':    1.0083740, 
          'e-':    5.4858e-4, 
          }
...
polarisabilities = {'H2O':   1.45e-24, 'CO2':   2.91e-24, 'CH4':   2.59e-24, 
                    ...
                    'O3':    3.21e-24, 'C2H6S': 7.41e-24, 'Al':    6.80e-24, 
                    'Ba':    39.7e-24, 'Ba+':   39.7e-24, 'Ca':    22.8e-24, 
                    'Ca+':   22.8e-24, 'Cr':    11.6e-24, 'Cs':    59.4e-24, 
                    'Fe':    9.47e-24, 'Fe+':   9.47e-24, 'Li':    24.3e-24, 
                    'Mg':    10.6e-24, 'Mg+':   10.6e-24, 'Mn':    9.40e-24, 
                    'Ni':    6.80e-24, 'O':     0.80e-24, 'Rb':    47.4e-24, 
                    'Sc':    17.8e-24, 'Ti':    14.8e-24, 'Ti+':   14.8e-24,
