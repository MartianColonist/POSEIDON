...
First demonstration of POSEIDON's capabilities, including free chemistry retrievals 
with patchy clouds on HD 209458b's Hubble transmission spectrum.
...
Application of POSEIDON to a population of hot Jupiters, finding evidence of
nitrogen-bearing molecules (NH3 and/or HCN) in the atmospheres of three hot Jupiters.
...
POSEIDON identified TiO for the first time in an exoplanet atmosphere, using
VLT FORS2 transmission spectra of WASP-19b. 
...
POSEIDON was generalised for Neptune-mass planets, with an application to the
...
Application of POSEIDON to identifying a bias in retrieved temperatures from 
exoplanet transmission spectra of hot giant planets.
...
First demonstration of POSEIDON's capabilities for modelling and retrieving rocky 
exoplanet transmission spectra, with an application to a simulated Earth-like planet 
...
Application of POSEIDON to the Hubble near-UV transmission spectrum of HAT-P-41b, 
revealing signatures of H-.
...
Application of POSEIDON to the Hubble and Spitzer transmission spectrum of WASP-62b.
...
Application of POSEIDON to the ACCESS and LRG-BEASTS transmission spectrum of WASP-103b.
...
Application of POSEIDON to simulating the detectability of molecules in 
...
Development of POSEIDON's 3D radiative transfer model, TRIDENT, and demonstration 
of its capabilities for modelling and 2D and 3D exoplanet transmission spectra.
...
Release of the first open-source version of POSEIDON.
...
Catalogue of exoplanet atmospheric retrieval codes (including POSEIDON).
...
Release of the open-source code Cthulhu, which was used to compute POSEIDON's cross sections.
...
Inclusion of nightside thermal emission in transmission spectra.
...
Added Mie scattering aerosols in transmission and emission, two-stream thermal scattering, 
reflection spectra, contribution functions (spectral + pressure), precomputed aerosol database, 
gas opacity updates, and new P-T profiles (Guillot, Line, Pelletier). 
...
Application of POSEIDON to reanalyse K2-18b's JWST NIRISS and NIRSpec transmission spectra, 
finding no evidence of DMS.
...
Development of high-resolution cross correlation retrievals for transmission and emission spectra.
...
Extended Mie scattering modelling, including an updated aerosol database with 
directional and temperature dependent aerosols.
...
First application of POSEIDON to a directly imaged planet/brown dwarf emission spectrum.
