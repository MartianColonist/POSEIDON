...
wl_min = 0.40  # Minimum wavelength (um)
wl_max = 0.95  # Maximum wavelength (um)
...
data = read_high_res_data(data_dir, names=names, retrieval=True)
# %%
